...
SPECS={ 'fridge':{'name':'冰箱 R2 单凸形','size_axis':'width','size':110,'points':[[260,90],[993,90],[1105,202],[1106,1046],[994,1159],[260,1159],[149,1040],[150,204]],'surfaces':{'top':[[260,90],[993,90]],'foot':[[260,1159],[994,1159]]}} }
...
(ROOT/'GEOMETRY.json').write_text(json.dumps({'version':'difficulty-r1-fridge-r2','coordinate_system':'x-right y-up; collider bounds center at local origin; world units','assets':rows},ensure_ascii=False,indent=2)+'\n')
