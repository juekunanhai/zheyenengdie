...
const ROOT = __dirname, OUT = path.join(ROOT, 'evidence/livelier-r1');
const hash = file => crypto.createHash('sha256').update(fs.readFileSync(file)).digest('hex');
const url = 'http://127.0.0.1:8767/preparation/design/home-expression-r2/index.html?revision=livelier-r1';
