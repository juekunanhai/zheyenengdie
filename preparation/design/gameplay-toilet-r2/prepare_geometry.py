...
# Pixel vertices were selected on alpha>=128. Three nearly horizontal bearing
# surfaces are flattened within 3 source pixels (under 0.5 world units).
POINTS=[[31,12],[275,12],[292,27],[294,57],[283,72],[282,285],
[310,276],[690,276],[744,283],[767,298],[774,319],[768,362],
[756,412],[727,459],[689,495],[647,520],[606,540],[601,553],
[603,571],[622,599],[655,624],[692,646],[703,665],[707,701],
[679,717],[54,717],[42,700],[43,666],[51,648],[79,618],
[96,586],[105,530],[91,465],[68,431],[39,410],[27,375],
[22,78],[11,68],[9,40],[15,20]]
...
measure={'high_plateau':span(31,275,12),'low_plateau':span(310,690,276),'foot':span(54,679,717),'step_height_world':round(264*s,6)}
...
'notes':'Integrated broad foot reaches beneath left tank. Both separate support ledges and under-bowl recesses remain real. Near-horizontal alpha-bearing edges simplified within 3 source pixels; no concavity is convex-filled.'}
(ROOT/'GEOMETRY.json').write_text(json.dumps({'version':'gameplay-toilet-r2-first-art','coordinate_system':'x-right y-up, collider bounds center at local origin; world units','assets':[row]},ensure_ascii=False,indent=2)+'\n')
...
report={'slug':'toilet','outline_vertices':n,'simple_polygon':not hits,'self_intersections':hits,'concave_vertices':concave,
 ...
 'high_plateau_alpha_deviation_world_max':round(3*s,6),
 'visual_alpha_height_world':round((718-9)*s,6),'bearing_outline_height_world':115,
 'measurements':measure,'target_comparison':{'width_target':125,'width_actual':row['width'],'high_width_target':[40,46],'high_width_actual':measure['high_plateau']['width_world'],'low_width_target':[55,65],'low_width_actual':measure['low_plateau']['width_world'],'foot_width_target':[96,108],'foot_width_actual':measure['foot']['width_world'],'step_height_target':[35,40],'step_actual':measure['step_height_world']},
 'notes':'Raster metrics are visual diagnostics, not Cocos physics acceptance. The high plateau is slightly narrower and the step 3.1 units taller than nominal target. Flattening 1-3 pixels follows the nearly horizontal visible lips; it does not invent a broad invisible platform.'}
