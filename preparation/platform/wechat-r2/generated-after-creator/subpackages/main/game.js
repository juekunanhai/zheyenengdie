    ...
    execute: function () {
      ...
      var GameAudio = exports('GameAudio', /*#__PURE__*/function () {
        function GameAudio(node, clips) {
          ...
          this.clock = 0;
          this.lastReactionAt = Number.NEGATIVE_INFINITY;
          this.hide = function () {
            _this.hidden = true;
            _this.stop();
          };
        ...
        _proto.isReacting = function isReacting() {
          var _this2 = this;
          return this.voices.some(function (v) {
            return v.reaction && (v.source.playing || v.availableAt > _this2.clock);
          });
        }
        /** Accidents interrupt comments without suppressing impact or star-loss feedback. */;
        _proto.stopReactions = function stopReactions() {
        ...
        _proto.play = function play(name, volume, pairKey) {
          ...
          var busy = function busy(v) {
            return v.source.playing || v.availableAt > _this3.clock;
          };
          var collision = name.startsWith('impact_');
          var reaction = name.startsWith('voice_');
    ...
    execute: function () {
      ...
      var StackGameController = exports('StackGameController', (_dec = ccclass('StackGameController'), _dec2 = property([SpriteFrame]), _dec3 = property([AudioClip]), _dec(_class = (_class2 = /*#__PURE__*/function (_Component) {
        ...
        function StackGameController() {
          ...
          _this.firstTouchGreeted = false;
          _this.playfulReactionUsed = false;
          return _this;
        }
        ...
        _proto.lateUpdate = function lateUpdate(dt) {
          ...
          this.music.update(Math.min(dt, .067), this.display.getViewHeight(), this.incident !== null, this.phase === 'defeated' || this.phase === 'ended', this.audio.isReacting());
        };
  ...
  return {
    ...
    execute: function () {
      ...
      var GameMusic = exports('GameMusic', /*#__PURE__*/function () {
        ...
        _proto.update = function update(dt, viewHeight, incident, defeated, reacting) {
          if (incident === void 0) {
            incident = false;
          }
          if (defeated === void 0) {
          ...
          var targetGain = defeated ? 0 : incident || reacting ? .09 : .28;
          var gainSpeed = reacting && targetGain < this.gain ? 1.8 : .3;
...
System.register("chunks:///_virtual/scene-actions.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './game-audio.ts', './local-platform.ts'], function (exports) {
  var _applyDecoratedDescriptor, _inheritsLoose, _initializerDefineProperty, _assertThisInitialized, cclegacy, _decorator, SpriteFrame, AudioClip, Node, game, Game, UITransform, Label, Color, director, AudioSource, isValid, Component, Sprite, GameAudio, markUserInteraction, bindAction, readSettings, writeSettings, hasUserInteraction;
  return {
    setters: [function (module) {
      _applyDecoratedDescriptor = module.applyDecoratedDescriptor;
      _inheritsLoose = module.inheritsLoose;
    ...
    execute: function () {
      ...
      var StackSceneActions = exports('StackSceneActions', (_dec = ccclass('StackSceneActions'), _dec2 = property([SpriteFrame]), _dec3 = property(AudioClip), _dec4 = property(AudioClip), _dec5 = property(AudioClip), _dec(_class = (_class2 = /*#__PURE__*/function (_Component) {
        ...
        function StackSceneActions() {
          ...
          _initializerDefineProperty(_this, "homeMusicClip", _descriptor4, _assertThisInitialized(_this));
          _this.navigating = false;
          _this.audio = void 0;
          _this.homeMusic = null;
          _this.homeMusicGain = 0;
          _this.homeSuspended = false;
          _this.onHomeTouch = function () {
            markUserInteraction();
            _this.syncHomeMusic();
          };
          _this.onHomeHide = function () {
            _this.homeSuspended = true;
            _this.stopHomeMusic();
          };
          _this.onHomeShow = function () {
            _this.homeSuspended = false;
            _this.syncHomeMusic();
          };
          return _this;
        ...
        _proto.syncHomeMusic = function syncHomeMusic() {
          var _this4 = this;
          if (!this.homeMusicClip || this.navigating || this.homeSuspended || !hasUserInteraction() || !readSettings().music) {
            this.stopHomeMusic();
            return;
          }
          if (this.homeMusic) return;
          var child = new Node('HomeMusic');
          ...
          child.on(AudioSource.EventType.STARTED, function () {
            if (_this4.homeMusic === source && (_this4.navigating || _this4.homeSuspended || !readSettings().music)) _this4.stopHomeMusic();
          });
          source.play();
        };
        _proto.stopHomeMusic = function stopHomeMusic() {
          var source = this.homeMusic;
          this.homeMusic = null;
          this.homeMusicGain = 0;
        ...
        _proto.update = function update(dt) {
          var _this$audio, _this$homeMusic;
          (_this$audio = this.audio) == null || _this$audio.update(dt);
          if (!this.homeMusicClip) return;
          this.syncHomeMusic();
          if ((_this$homeMusic = this.homeMusic) != null && _this$homeMusic.playing) {
        ...
        _proto.onDestroy = function onDestroy() {
          ...
          game.off(Game.EVENT_HIDE, this.onHomeHide);
          game.off(Game.EVENT_SHOW, this.onHomeShow);
          this.stopHomeMusic();
      ...
      }), _descriptor4 = _applyDecoratedDescriptor(_class2.prototype, "homeMusicClip", [_dec5], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
